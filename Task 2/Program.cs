namespace Task_2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("\n=== Operator Overloading Of the Account Class =================================");
            Account overloading1 = new Account("acc1", 2000);
            Account overloading2 = new Account("acc2", 3000);

            Account balanceOverloading = overloading1 + overloading2;
            Console.WriteLine(balanceOverloading);
